...
const nextConfig = {
  ...
  // 2. Minification via SWC pour un build plus léger
  swcMinify: true,
  ...
  images: {
    domains: [
      'cdn.discordapp.com',       // avatars Discord
      process.env.SUPABASE_URL?.replace(/^https?:\/\//, '')  // stockage Supabase
    ]
  },
  ...
  // 6. i18n (si besoin), ici FR par défaut
  i18n: {
    locales: ['fr'],
    defaultLocale: 'fr'
  },
